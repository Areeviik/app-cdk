...
class CodePipelineBackendStack(Stack):
    def __init__(
        ...
        build_project= codebuild.PipelineProject(self, "BackendBuildProject",
            project_name=f"{prj_name}-{env_name}-backend-build",
        ...
        pipeline = codepipeline.Pipeline(self, "BackendPipeline",
            pipeline_name=f"{prj_name}-{env_name}-backend-pipeline-v2",
